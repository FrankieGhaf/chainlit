# Automated maintenance for chainlit

This public portfolio copy is maintained by [FrankieGhaf](https://github.com/FrankieGhaf). The original project is [Chainlit/chainlit](https://github.com/Chainlit/chainlit); its authors retain credit for their work. Original license and notice files and the default branch's Git history are preserved.
...
```sh
sudo -Hu frankieghaf /usr/bin/python3 /home/frankieghaf/bin/sync_repositories.py --repo chainlit
```
